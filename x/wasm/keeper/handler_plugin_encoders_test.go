			...
			srcMsg: wasmvmtypes.CosmosMsg{
				Staking: &wasmvmtypes.StakingMsg{
					Delegate: &wasmvmtypes.DelegateMsg{
						...
						Amount:    wasmvmtypes.NewCoin(777, "silk"),
					},
				},
			},
			output: []sdk.Msg{
				&stakingtypes.MsgDelegate{
					...
					Amount:           sdk.NewInt64Coin("silk", 777),
				},
			},
		},
			...
			srcMsg: wasmvmtypes.CosmosMsg{
				Staking: &wasmvmtypes.StakingMsg{
					Undelegate: &wasmvmtypes.UndelegateMsg{
						Validator: valAddr.String(),
						Amount:    wasmvmtypes.NewCoin(555, "silk"),
					},
				},
			},
			output: []sdk.Msg{
				&stakingtypes.MsgUndelegate{
					DelegatorAddress: addr1.String(),
					ValidatorAddress: valAddr.String(),
					Amount:           sdk.NewInt64Coin("silk", 555),
				},
			},
		},
		"staking redelegate": {
			...
			srcMsg: wasmvmtypes.CosmosMsg{
				Staking: &wasmvmtypes.StakingMsg{
					Redelegate: &wasmvmtypes.RedelegateMsg{
						...
						Amount:       wasmvmtypes.NewCoin(222, "silk"),
					},
				},
			},
			output: []sdk.Msg{
				&stakingtypes.MsgBeginRedelegate{
					...
					Amount:              sdk.NewInt64Coin("silk", 222),
				},
			},
		},
